...
The Steam silo is the gamer-focused QuantumLink edition. It layers Steam-safe routing, game profiles, low-latency host selection, streamer privacy, and party-oriented diagnostics on top of the shared `rust/qlink-core` protocol foundation.

Steam-specific work belongs here. The shared handshake, packet framing, peer records, rendezvous, relay, and transport primitives remain in `rust/qlink-core`.
